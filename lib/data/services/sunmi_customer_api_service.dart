...
class SunmiCustomerApiService {
  static const MethodChannel _channel =
      MethodChannel('com.holox.ailand_pos/sunmi_customer_api');

  /// 单例模式
  static final SunmiCustomerApiService _instance = SunmiCustomerApiService._internal();
  ...
  Future<String?> getDeviceSerialNumber() async {
    try {
      final String? serialNumber = await _channel.invokeMethod('getDeviceSerialNumber');
      return serialNumber;
    } on PlatformException catch (e) {
