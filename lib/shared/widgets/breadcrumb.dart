...
class Breadcrumb extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final defaultTextColor = disabled ? const Color(0xFFCCCCCC) : (textColor ?? const Color(0xFF666666));
    final defaultActiveColor = disabled ? const Color(0xFFCCCCCC) : (activeColor ?? const Color(0xFF333333));
    final defaultSeparatorColor = disabled ? const Color(0xFFE8E8E8) : (separatorColor ?? const Color(0xFFCCCCCC));
...
class _BreadcrumbItemWidgetState extends State<_BreadcrumbItemWidget> {
  ...
  @override
  Widget build(BuildContext context) {
    final isClickable = widget.item.path != null && !widget.isLast && !widget.disabled;
