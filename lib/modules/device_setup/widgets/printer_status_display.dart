      ...
      child: Column(
        ...
        children: [
          ...
          if (detailInfo != null) ...[
            ...
            Divider(color: const Color(0xFF52C41A).withValues(alpha: 0.2), height: 1.h),
      ...
      child: Column(
        ...
        children: [
          ...
          if (detailInfo != null) ...[
            ...
            Divider(color: const Color(0xFFE74C3C).withValues(alpha: 0.2), height: 1.h),
            SizedBox(height: 10.h),
            _buildDetailRow('ID', detailInfo.printerId ?? '--'),
            SizedBox(height: 6.h),
            _buildDetailRow('名称', detailInfo.printerName ?? '--'),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          if (detailInfo != null) ...[
            SizedBox(height: 12.h),
            Divider(color: const Color(0xFFF39C12).withValues(alpha: 0.2), height: 1.h),
            SizedBox(height: 10.h),
            _buildDetailRow('ID', detailInfo.printerId ?? '--'),
            SizedBox(height: 6.h),
            _buildDetailRow('名称', detailInfo.printerName ?? '--'),
