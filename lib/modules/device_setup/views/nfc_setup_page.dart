      ...
      child: Column(
        children: [
          NfcDeviceStatus(
            ...
            onEnableNfc: status == 'disabled' ? controller.openNfcSettings : null,
          ),
          // 如果是未启用状态，显示重新检测按钮
          if (status == 'disabled') ...[
            ...
            SizedBox(
              ...
              child: TextButton.icon(
                ...
                style: TextButton.styleFrom(
                  padding: EdgeInsets.symmetric(vertical: 12.h), // 增加内边距
                ),
              ),
            ),
          ],
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  ...
                  padding: EdgeInsets.symmetric(vertical: 14.h), // 增加内边距
