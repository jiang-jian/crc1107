...
class DeviceSetupController extends GetxController {
    ...
    try {
      ...
      if (success) {
        ...
        Get.snackbar(
          '成功',
          '打印测试通过！',
          backgroundColor: const Color(0xFF52C41A).withValues(alpha: 0.1),
          colorText: const Color(0xFF52C41A),
        );
      } else {
  ...
  Future<Map<String, dynamic>> testPrinterFullChain() async {
    ...
    final successCount =
        steps.values.where((step) => step['success'] == true).length;
